<template>
  <section class="flex flex-col items-center gap-6">
    <img src="/jacko.jpg" class="w-64 h-64 rounded-full" />
    <h1 class="text-center font-bold text-2xl">Jacko's Existential Support</h1>
...
const thread = useCookie("open-ai-thread-id");
const run = useCookie("open-ai-run-id");
